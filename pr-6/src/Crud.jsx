        ...
        <div>
            <div className="container-fluid p-5">
                ...
                <form onSubmit={HandleSubmit} className="m-auto rounded p-5 mb-5 text-dark  flex items-center justify-center w-25 shadow-lg pt-" >
                    <center><h1 className='rounded-3 text-light bg-dark py-2'>Add Employee</h1></center>
                ...
                <center><h1 className='rounded-3 w-75 text-light bg-dark py-2'>Employee List</h1></center>
                <table className="mt-5 table table-striped p-5">
                    <thead>
                        <tr>
                            <th scope="col">Id</th>
